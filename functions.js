    ...
    for (let interview of interviewList) {
        ...
        <div class="full-card p-5  bg-white border border-[black] rounded-xl">
                <div class="flex justify-between">
                    ...
                    <button id="delete-btn" class="w-20 h-10 flex items-center justify-center border rounded-xl border-red-500 gap-1"><i class="fa-regular fa-trash-can text-[#64748B]"></i>Delete</button>
                </div>
